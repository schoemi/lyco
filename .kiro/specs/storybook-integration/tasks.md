...
- [ ] 1. Storybook-Abhängigkeiten installieren und Basiskonfiguration erstellen
  - [ ] 1.1 Storybook-Pakete als devDependencies installieren
  ...
  - [ ] 1.2 `.storybook/main.ts` erstellen
  ...
  - [ ] 1.3 `.storybook/preview.ts` erstellen
    - Import von `../src/app/globals.css` für Tailwind CSS 4
    - Controls-Matchers für Color und Date konfigurieren
    - _Requirements: 1.4, 3.1, 3.2, 3.3_

  - [ ] 1.4 NPM-Scripts in `package.json` hinzufügen
    - `"storybook": "storybook dev -p 6006"`
    - `"build-storybook": "storybook build"`
    - _Requirements: 2.1, 2.2, 2.3, 2.4_

- [ ] 2. Checkpoint – Basiskonfiguration prüfen
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Beispiel-Stories für bestehende Komponenten erstellen
  - [ ] 3.1 ScorePill Story erstellen (`src/components/cloze/score-pill.stories.tsx`)
    - Meta mit `title: "Cloze/ScorePill"`, `tags: ["autodocs"]`
    - Stories: Default (7/10), Perfect (10/10), Zero (0/10)
    - _Requirements: 5.1, 5.4_

  - [ ] 3.2 DifficultySelector Story erstellen (`src/components/cloze/difficulty-selector.stories.tsx`)
  ...
  - [ ] 3.3 ProgressBar Story erstellen (`src/components/songs/progress-bar.stories.tsx`)
    - Meta mit `title: "Songs/ProgressBar"`, `tags: ["autodocs"]`
    - Stories: Empty (0), Half (50), Full (100), Overflow (150)
    - _Requirements: 5.3, 5.4_

- [ ] 4. Introduction-Dokumentationsseite erstellen
  - [ ] 4.1 `src/stories/Introduction.mdx` erstellen
...
- [ ] 5. Git-Konfiguration anpassen
  - [ ] 5.1 `storybook-static/` zur `.gitignore` hinzufügen
    - Eintrag am Ende der Datei unter einem neuen `# storybook`-Kommentar
    - _Requirements: 7.1_

- [ ] 6. Final-Checkpoint – Alle Dateien und Konfiguration validieren
  - Ensure all tests pass, ask the user if questions arise.
