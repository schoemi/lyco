      ...
      >
        ...
        <div className="flex items-center justify-between border-b px-4 py-3">
          ...
          <button
            ...
            type="button"
            onClick={onCancel}
            className="min-h-[44px] min-w-[44px] flex items-center justify-center rounded text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
        ...
        <div className="flex flex-wrap gap-2 border-b px-4 py-2">
          <button
            ...
            className="min-h-[44px] rounded bg-gray-100 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
          >
            Alle auswählen
          </button>
          <button
          ...
          <button
            ...
            className="min-h-[44px] rounded bg-orange-100 px-3 py-2 text-sm font-medium text-orange-700 hover:bg-orange-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
          >
            Schwächen üben
          </button>
        </div>
        ...
        <div className="flex justify-end gap-2 border-t px-4 py-3">
          <button
            type="button"
            onClick={onCancel}
            className="min-h-[44px] rounded bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
          >
            Abbrechen
          </button>
          <button
            ...
            className="min-h-[44px] rounded bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
          >
            Übung starten
          </button>
        </div>
