...
import { WEAKNESS_THRESHOLD } from "@/lib/shared/constants";
import {
  getWeakStrophenIds,
  hasWeaknesses,
...
export function StrophenAuswahlDialog({
  ...
  const handlePracticeWeaknesses = () => {
    ...
    const lernbareIdsForWeak = new Set(lernbareStrophen.map((s) => s.id));
    const lernbareProgressForWeak = progress.filter((p) => lernbareIdsForWeak.has(p.stropheId));
    const weak = getWeakStrophenIds(lernbareProgressForWeak);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="quiz-strophen-dialog-title"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b px-4 py-3">
          ...
          <button
            ...
            type="button"
            onClick={onCancel}
            className="min-h-[44px] min-w-[44px] flex items-center justify-center rounded text-neutral-500 hover:text-neutral-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
        ...
        <div className="flex flex-wrap gap-2 border-b px-4 py-2">
          <button
            ...
            className="min-h-[44px] rounded bg-neutral-100 px-3 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            Alle auswählen
          </button>
          <button
          ...
          <button
            ...
            className="min-h-[44px] rounded bg-warning-100 px-3 py-2 text-sm font-medium text-warning-700 hover:bg-warning-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            Schwächen üben
          </button>
        </div>
        ...
        <div className="flex justify-end gap-2 border-t px-4 py-3">
          <button
            type="button"
            onClick={onCancel}
            className="min-h-[44px] rounded bg-neutral-100 px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            Abbrechen
          </button>
          <button
            ...
            className="min-h-[44px] rounded bg-primary-600 px-4 py-2 text-sm font-medium text-white hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
          >
            Übung starten
          </button>
        </div>
