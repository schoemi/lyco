  ...
  return (
    <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
      <button
        ...
        className="flex min-h-[44px] w-full items-center justify-between gap-2 px-4 py-3 text-left transition-colors hover:bg-gray-50"
      >
      ...
      {expanded && (
        <div id={`set-${set.id}-songs`} role="list" className="divide-y divide-gray-100 px-2 pb-2">
          {set.songs.map((song) => (
